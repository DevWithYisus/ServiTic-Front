...
import perfilUsu from "../../assets/images/perfilUsuario.png";
import { ContextoUsuario } from "../security/ContextoUsuario";
import { OcultarMenu } from "../utilities/functions/OcultarMenu";
  ...
  return (
    <header id="header" className="header fixed-top d-flex align-items-center">
      <div className="d-flex align-items-center justify-content-between">
        <Link to="/dashboard">
          <img src={miLogo} alt="" style={{ paddingRight: "10px" }} />
        </Link>
      ...
      <nav className="header-nav ms-auto">
        <ul className="d-flex align-items-center">
          ...
          <li className="nav-item dropdown">
            <a
              className="nav-link nav-icon text-black"
              href="/#"
              data-bs-toggle="dropdown"
            >
              <i className="bi bi-bell"></i>
              <span className="badge bg-warning badge-number">4</span>
            </a>
            ...
            <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
              <li className="dropdown-header">
                ...
                <a href="/#">
                  <span className="badge rounded-pill bg-warning p-2 ms-2">
                    View all
                  </span>
                </a>
              </li>
              ...
              <li className="dropdown-footer">
                <a href="/dashboard/*">Show all notifications</a>
              </li>
            </ul>
          </li>
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
              ...
              <li className="dropdown-footer">
                <a href="/dashboard/*">Show all messages</a>
              </li>
          ...
          <li className="nav-item dropdown pe-3">
            <a
              className="nav-link nav-profile d-flex align-items-center pe-0 text-black"
